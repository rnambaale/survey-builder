...
$(document).on("click", ".add-choice", function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      console.log(data);
      $("#add-choice_".concat(question)).removeAttr("disabled");
      $("#choices_inner_".concat(question)).append("\n                <div class=\"choice\" id=\"choice_".concat(data.choice_ID, "\">                <input                    type=\"hidden\"                    name=\"choices[").concat(data.choice_ID, "][ID]\"                    value=\"").concat(data.choice_ID, "\" />\n                <input                    type=\"hidden\"                    name=\"choices[").concat(data.choice_ID, "][question_ID]\"                    value=\"").concat(question, "\" />\n                    <div class=\"row\">                        <div class=\"form-group form-group-sm\">                            <label class=\"col-md-2 control-label\">Choice ").concat(data.choice_order, "</label>                            <div class=\"col-md-8\">                                <input type=\"\" name=\"choices[").concat(data.choice_ID, "][choice_text]\" class=\"form-control\">                            </div>                            <div class=\"col-md-2\">                                <a                                     href=\"#\"                                    class=\"btn btn-default btn-sm delete-choice\"                                    data-choice=\"").concat(data.choice_ID, "\"                                    data-question=\"").concat(question, "\"                                >Delete Choice</a>                            </div>                        </div>                    </div>                </div>            "));
    }
  });
});
$(document).on("click", ".delete-choice", function (e) {
  ...
  $.ajax({
    ...
    success: function success(data) {
      console.log(data);
      $("#question_".concat(data.question_ID, " #choice_").concat(choice)).remove();
    },
    error: function error(data) {
      console.log(data);
    }
